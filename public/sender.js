...
const GRID_ORIGIN = { x: 4, y: 4 }; // top-left corner of the 16×16 data grid

const ANCHORS = [
  { x: 1, y: 1,  hollow: false }, // TL
  { x: 21, y: 1, hollow: false }, // TR
  { x: 1, y: 21, hollow: false }, // BL
  { x: 21, y: 21, hollow: true }, // BR — orientation marker
];
